// lib/features/store/presentation/screens/listing_detail_page.dart
        ...
        children: [
          ...
          if (item.pricePerKg > 0) ...[
            _buildDetailRow(
              ...
              label: 'Price per kg',
              value: 'Rs. ${item.pricePerKg.toStringAsFixed(2)}',
          ...
          if (item.quantityKg > 0) ...[
            _buildDetailRow(
              ...
              value: '${item.quantityKg.toStringAsFixed(0)} kg',
          ...
          if (item.pricePerKg > 0 && item.quantityKg > 0) ...[
            _buildDetailRow(
              ...
              label: 'Total value',
              value:
                  'Rs. ${(item.pricePerKg * item.quantityKg).toStringAsFixed(0)}',
